...
# provider_stats.json is a read-modify-write file; without this lock, concurrent
# article generation (multiple threads calling log_request around the same time)
# would race and silently drop updates.
